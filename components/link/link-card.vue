...
<template>
  <li>
    ...
    >
      <div class="md:flex md:justify-between imd:tems-center md:gap-4">
        <div class="flex items-center flex-auto">
          ...
          <div class="flex-auto w-0 md:mr-4">
            <div class="flex items-center justify-between md:justify-normal relative">
        ...
        <div class="mt-4 md:mt-0 flex items-center justify-between space-x-4">
